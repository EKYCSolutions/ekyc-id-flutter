...
class DualRingFast extends StatefulWidget {
  const DualRingFast({
    Key? key,
    required this.color,
    this.lineWidth = 7.0,
  ...
  @override
  _DualRingFastState createState() => _DualRingFastState();
}

class _DualRingFastState extends State<DualRingFast>
...
class _DualRingFastPainter extends CustomPainter {
  _DualRingFastPainter(
